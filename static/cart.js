...
window.addEventListener('click', function (event) {
        if (event.target.hasAttribute('data-cart')) {
            ...
            if (itemInCart) {
                ...
                const cartItemHTML = `<div class="idk card mb-3" data-id="${productInfo.price}" id="s" style="width: 698px;margin-left: 19px; max-height:200px; box-shadow: none;">
                <div class=" row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="title card-titles"style="font-size: 15px; margin-top: 24px">${productInfo.title}</h5>
...
`;
                ...
                if (view.children.length > 0) {
                    ...
                    localStorage.setItem('name',(localStorage.getItem('name')) + ', '+ productInfo.title);


                } else {
                    cartWrapper.insertAdjacentHTML('beforeend', cartItemHTML);
                    localStorage.setItem('div', cartItemHTML);
                    localStorage.setItem('name', productInfo.title);
                }
                caclCartPrice();
